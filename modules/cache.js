module.exports = (clientMongo) => {
    ...
    async function wipe(database, collection) {
        if (!database) {
            throw new Error("No database specified to put");
        }
        if (!collection) {
            throw new Error("No collection specified to put");
        }
    ...
    async function put(database, collection, matchCondition, saveObject, autoUpdate = true) {
        ...
        if (!saveObject) {
            throw new Error("No object provided to put");
        }
    ...
    async function get(database, collection, matchCondition, projection) {
        if (!database) {
            throw new Error("No database specified to get");
        }
        if (!collection) {
            throw new Error("No collection specified to get");
        }
